...
# =============================================================================
# Teaser Narrative Generation — Request & Response
# =============================================================================


class TeaserNarrativeWordBudget(BaseModel):
    """Word budget guardrails per teaser narrative field."""

    min_words: int = Field(..., ge=0)
    max_words: int = Field(..., ge=1)


class TeaserNarrativeWordBudgets(BaseModel):
    """Section-specific word budgets for teaser narrative generation."""

    overview: TeaserNarrativeWordBudget = Field(
        default_factory=lambda: TeaserNarrativeWordBudget(min_words=90, max_words=140)
    )
    financial: TeaserNarrativeWordBudget = Field(
        default_factory=lambda: TeaserNarrativeWordBudget(min_words=70, max_words=110)
    )
    technical: TeaserNarrativeWordBudget = Field(
        default_factory=lambda: TeaserNarrativeWordBudget(min_words=70, max_words=110)
    )
    regulatory: TeaserNarrativeWordBudget = Field(
        default_factory=lambda: TeaserNarrativeWordBudget(min_words=40, max_words=80)
    )
    esg: TeaserNarrativeWordBudget = Field(
        default_factory=lambda: TeaserNarrativeWordBudget(min_words=50, max_words=90)
    )
...
class TeaserNarrativeGenerationResponse(BaseModel):
    """Bounded teaser narrative output returned to NestJS."""
